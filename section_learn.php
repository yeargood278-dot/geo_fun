...
<head>
    ...
    <style>
        ...
        /* 喀斯特峰林 (三角形群) */
        .css-karst { width: 300px; height: 150px; position: relative; border-bottom: 5px solid #7f8c8d; }
        ...
        /* 河流 (S型曲线) */
        .css-river-valley { width: 300px; height: 200px; background: #a5d6a7; position: relative; overflow: hidden; }
        ...
        .river-path::after { content:''; position: absolute; top: 20px; left: 100px; width: 20px; height: 20px; background: #fff; border-radius: 50%; } /* 模拟波光 */
        
        /* 海岸地貌 */
        .css-coast { width: 300px; height: 150px; background: #f1c40f; position: relative; overflow: hidden;}
        ...
        /* 沙丘 (新月形) */
        .css-dune { width: 300px; height: 150px; position: relative; }
        ...
        /* 1. 森林分层 (Vegetation Layers) */
        .css-veg-layer { width: 300px; height: 200px; position: relative; border-bottom: 5px solid #795548; background: linear-gradient(to bottom, #e1f5fe 0%, #fff 80%); }
        ...
        /* 2. 红树林 (Mangrove) */
        .css-mangrove { width: 300px; height: 180px; position: relative; overflow: hidden; }
        .mangrove-water { width: 100%; height: 60px; background: #81d4fa; position: absolute; bottom: 0; opacity: 0.7; }
        .mangrove-roots { width: 100%; height: 80px; position: absolute; bottom: 0; 
            background-image: radial-gradient(circle, transparent 40%, #5d4037 41%); 
            background-size: 30px 40px; background-position: 0 10px; }
        ...
        .pile-sand { height: 60px; background: #fff3e0; border: 2px solid #ffe0b2; } /* 砂土 */
        .pile-loam { height: 80px; background: #8d6e63; border: 2px solid #5d4037; } /* 壤土 */
        .pile-clay { height: 60px; background: #bcaaa4; border: 2px solid #795548; } /* 黏土 */

        /* 4. 土壤剖面 (Soil Profile - Forest) */
        ...
        .profile-o { height: 10%; background: #333; display:flex;align-items:center;justify-content:center; } /* 有机层 */
        .profile-a { height: 20%; background: #212121; display:flex;align-items:center;justify-content:center; } /* 腐殖质 */
        .profile-e { height: 15%; background: #bdbdbd; color:#333; display:flex;align-items:center;justify-content:center; } /* 淋溶 */
        .profile-b { height: 25%; background: #795548; display:flex;align-items:center;justify-content:center; } /* 淀积 */
        .profile-c { height: 20%; background: #ffe0b2; color:#333; display:flex;align-items:center;justify-content:center; } /* 母质 */
        .profile-r { height: 10%; background: #607d8b; display:flex;align-items:center;justify-content:center; } /* 母岩 */
        ...
        /* 1. 台风 (Typhoon) */
        .css-typhoon { width: 300px; height: 300px; position: relative; display: flex; align-items: center; justify-content: center; }
        ...
        /* 2. 洪水 (Flood) */
        .css-flood { width: 300px; height: 200px; position: relative; overflow: hidden; background: #e0f7fa; border-bottom: 5px solid #0277bd; }
        ...
        /* 3. 地震波 (Seismic Wave) */
        .css-seismic-wave { width: 300px; height: 150px; display: flex; align-items: center; justify-content: center; gap: 5px; }
        ...
        /* 6. 北斗/GNSS (GNSS Pin) */
        .css-gnss-pin { width: 300px; height: 200px; position: relative; background: #f0f3f4; }
